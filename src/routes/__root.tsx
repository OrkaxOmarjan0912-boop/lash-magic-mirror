...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Preview eyelash extension styles on your face with a live, on-device AR try-on. Private, no upload, no signup." },
      { property: "og:title", content: "LashMirror — Try lashes on before you book" },
      { property: "og:description", content: "Live AR lash try-on. Six signature styles. Nothing leaves your device." },
